...
const _records = [
  GuestRecord(
    checkIn: '2024-04-01', checkOut: '2024-04-03', nights: '2 nights',
    guests: 10, rooms: 4, purpose: 'Leisure',   transport: 'Private Car',
    status: GuestRecordStatus.active,
  ),
  GuestRecord(
    checkIn: '2024-04-05', checkOut: '2024-04-07', nights: '2 nights',
    guests: 6,  rooms: 3, purpose: 'Business',  transport: 'Bus',
    status: GuestRecordStatus.active,
  ),
  GuestRecord(
    checkIn: '2024-04-10', checkOut: '2024-04-12', nights: '2 nights',
    guests: 8,  rooms: 4, purpose: 'Leisure',   transport: 'Private Car',
    status: GuestRecordStatus.active,
  ),
  GuestRecord(
    checkIn: '2024-03-15', checkOut: '2024-03-17', nights: '2 nights',
    guests: 12, rooms: 5, purpose: 'Event',     transport: 'Van',
    status: GuestRecordStatus.active,
  ),
  GuestRecord(
    checkIn: '2024-03-20', checkOut: '2024-03-22', nights: '2 nights',
    guests: 4,  rooms: 2, purpose: 'Leisure',   transport: 'Motorcycle',
    status: GuestRecordStatus.archived,
  ),
  GuestRecord(
    checkIn: '2024-04-18', checkOut: '2024-04-20', nights: '2 nights',
    guests: 15, rooms: 6, purpose: 'Leisure',   transport: 'Private Car',
    status: GuestRecordStatus.active,
  ),
];
          ...
          return SingleChildScrollView(
            ...
            child: Column(
              ...
              children: [
                ...
                _GuestTable(records: _filtered, isNarrow: isNarrow),
              ],
            ),
          );
        },
    ...
    return Container(
      ...
      child: TextField(
        ...
        decoration: const InputDecoration(
          ...
          prefixIcon:
              Icon(Icons.search_rounded, color: AppColors.textSubtle, size: 20),
...
class _GuestTable extends StatelessWidget {
  const _GuestTable({required this.records, required this.isNarrow});
    ...
    return Row(
      children: [
        if (status == GuestRecordStatus.active) ...[
          ...
          const SizedBox(width: 8),
          _IconBtn(icon: Icons.archive_outlined, onTap: () {}),
          const SizedBox(width: 8),
        ],
        _IconBtn(
          icon: expanded
